    ...
    <div className="hop-settings" onMouseDown={onClose}>
      <div className="hop-settings__card" onMouseDown={(e) => e.stopPropagation()}>
        <div className="hop-settings__head">
          <h3 className="hop-settings__title">{t("settings.title")}</h3>
          <button className="hop-settings__close" onClick={onClose} aria-label={t("settings.close")}>
        ...
        <div className="hop-settings__foot">
          <button className="btn login-btn-filled" onClick={onClose}>{t("settings.done")}</button>
        </div>
      </div>
    </div>
  );
