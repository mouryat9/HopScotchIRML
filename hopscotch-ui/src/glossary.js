...
export const GLOSSARY = [
  ...
  { term: "Case Study", def: "An in-depth study of a single person, group, or situation to understand it deeply.", steps: [4] },
  { term: "Ethnography", def: "A qualitative design where the researcher immerses in a culture or group to understand it from the inside.", steps: [4] },
  { term: "Phenomenology", def: "A qualitative design that studies the lived experience of people around a particular event or idea.", steps: [4] },
  { term: "Grounded Theory", def: "A qualitative design that builds a new theory directly from the patterns found in the data.", steps: [4] },
  { term: "Action Research", def: "Research done to solve a real, practical problem through cycles of acting and reflecting, often by practitioners themselves.", steps: [4] },
  ...
  { term: "Interview", def: "A conversation with participants used to gather detailed, in-their-own-words data.", steps: [6] },

  // ---- Step 7: Analysis ----
  { term: "Data Analysis", def: "Making sense of your collected data to answer your research question.", steps: [7] },
  { term: "Descriptive Statistics", def: "Numbers that summarize data, such as averages, percentages, and ranges.", steps: [7] },
  { term: "Inferential Statistics", def: "Statistics that let you draw conclusions about a whole population from your sample.", steps: [7] },
  { term: "Mean / Median / Mode", def: "Three kinds of 'average': the mean is the total divided by the count, the median is the middle value, the mode is the most common value.", steps: [7] },
  { term: "Correlation", def: "A measure of how strongly two things move together. Note: correlation does not prove one causes the other.", steps: [7] },
  { term: "Regression", def: "A statistical method for predicting one variable from one or more others.", steps: [7] },
  { term: "Thematic Analysis", def: "A qualitative method that finds and organizes recurring themes across your data.", steps: [7] },
  { term: "Coding", def: "Labeling pieces of qualitative data (like interview quotes) so you can group and analyze them.", steps: [7] },
  { term: "Triangulation", def: "Using multiple methods or sources to cross-check findings and strengthen trust in them.", steps: [7, 8] },

  // ---- Step 8: Trustworthiness ----
  { term: "Validity", def: "Whether your study actually measures what it claims to measure.", steps: [8] },
  { term: "Reliability", def: "Whether your measurements are consistent and would give similar results if repeated.", steps: [8] },
  ...
  { term: "Bias", def: "Anything that unfairly tilts your results away from the truth.", steps: [8] },
